...
// SimpleFormatter formats logs into text
...
func (f *SimpleFormatter) isColored() bool {
...
func (f *SimpleFormatter) printColored(b *bytes.Buffer, entry *logrus.Entry, keys []string, timestampFormat string) {
	var levelColor int
	switch entry.Level {
...
func (f *SimpleFormatter) needsQuoting(text string) bool {
